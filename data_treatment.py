...
INSURER_CANONICAL_NAMES = {
    ...
    'canara hsbc obc life insurance': 'Canara HSBC',
    'canara hsbc life insurance': 'Canara HSBC',
    'canara hsbc obc life': 'Canara HSBC',
    'canara hsbc life': 'Canara HSBC',
    ...
    'bharti axa life insurance co ltd': 'Bharti AXA Life',
    ...
    'exide life insurance co ltd': 'Exide Life',
    ...
    'sud life': 'Star Union Dai-ichi Life',
...
def clean_insurer_name(name: str) -> str:
    ...
    # Remove special characters like $ and * at the end
    name = re.sub(r'[\$\*]+$', '', name)
...
def standardize_insurer(name: str, name_xwalk: Dict[str, str]) -> str:
    ...
    # Fuzzy matching using difflib - lowered threshold to 85 for better matching
    best_match = None
    best_score = 0
